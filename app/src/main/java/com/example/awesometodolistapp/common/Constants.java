...
public interface Constants extends DataConstants{
    ...
    //  add task screen
    String DATE_TIME_DISPLAY_FORMAT = "EEE, d MMM, hh:mm aaa";

    //  This constant is used in Task list screen.
    String DATE_DEADLINE_FORMAT = "d MMM";

    String ADD_TASK_FRAGMENT_TAG ="ADD_TASK";
}
