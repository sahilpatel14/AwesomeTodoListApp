...
import static com.ninthsemester.ui.common.Constants.DATE_TIME_DISPLAY_FORMAT;
import static com.ninthsemester.ui.common.Utils.getInputFromField;
...
public class AddTaskDialog extends DialogFragment
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.et_add_task_deadline) {
            openTimePicker();

        } else if (i == R.id.btn_add_task_save) {
            saveTask();

        } else if (i == R.id.btn_add_task_cancel) {
            mPresenter.requestedTaskListWindow();
